...
SRC:=$(GOPATH)/src/github.com/Darktris/reporter
...
.PHONY: docker-build
docker-build:
	@docker build -t darktris/grafana-reporter:2.1.0 -t darktris/grafana-reporter:latest .

docker-push:
	@docker push darktris/grafana-reporter
